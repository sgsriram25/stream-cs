...
if side == 'Monthly Customer Status':
    ...
    col1, col2 = st.columns(2)
    with col1:
        cat1 = Image.open('F:/Customer Segmentation/New folder/first/stream-cs/dashimage/dash1.png')
        st.image(cat1, caption='Category 1 Products')
    with col2:
        cat2 = Image.open('F:/Customer Segmentation/New folder/first/stream-cs/dashimage/dash2.png')
        st.image(cat2, caption='Category 2 Products')
    
    col3, col4 = st.columns(2)
    with col3:
        cat3 = Image.open('F:/Customer Segmentation/New folder/first/stream-cs/dashimage/dash3.png')
        st.image(cat3, caption='Category 3 Products')
    with col4:
        cat4 = Image.open('F:/Customer Segmentation/New folder/first/stream-cs/dashimage/dash4.png')
    ...
    with col5:
        gra1 = Image.open('F:/Customer Segmentation/New folder/first/stream-cs/dashimage/graph.jpeg')
